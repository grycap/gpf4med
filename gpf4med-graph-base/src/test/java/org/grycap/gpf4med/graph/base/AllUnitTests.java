...
import org.grycap.gpf4med.graph.base.mock.CloserServiceMock;
...
public class AllUnitTests { 
	...
	public static void setup() {
		...
		final URL anchorURL = AllUnitTests.class.getClassLoader().getResource(ANCHOR_FILENAME);
		...
		if (resDir != null && resDir.isDirectory() && resDir.canRead()) {
			...
			throw new IllegalStateException("Invalid test resources pathname: "
					+ TEST_RESOURCES_PATH);
		}
