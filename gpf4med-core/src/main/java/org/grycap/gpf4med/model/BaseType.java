...
public class BaseType {
	...
	private ConceptName conceptNameValue;
	private Optional<MeasurementUnits> measurementUnits = Optional.absent();

	public BaseType() { }

	public ConceptName getConceptNameValue() {
		return conceptNameValue;
	}

	public void setConceptNameValue(final ConceptName conceptNameValue) {		
		this.conceptNameValue = checkNotNull(conceptNameValue, "Uninitialized concept name value");
	}
	...
	public String toString() {
		return toStringHelper(this)
				.add("conceptNameValue", conceptNameValue)
